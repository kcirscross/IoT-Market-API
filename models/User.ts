...
export interface IUser {
  ...
  notifies?: mongoose.Types.ObjectId[];
  ...
  isReview?: mongoose.Types.ObjectId[];
  avatar: string;
...
const userSchema = new mongoose.Schema<IUser>(
  {
    ...
    avatar: {
      type: String,
      default:
        'https://firebasestorage.googleapis.com/v0/b/iotmarket-10501.appspot.com/o/logo.jpg?alt=media&token=ed49f7ba-f12d-469f-9467-974ddbdbaf74',
    },
  },
  { timestamps: true }
);
