...
import { approveStoreRequest, banUser, declineStoreRequest, getAllRequest, getRequestDetail, unbanUser, } from '../controllers/adminController.js';
...
router.patch('/reject/:storeRequestId', adminAuthentication, declineStoreRequest);
router.patch('/approve/:storeRequestId', adminAuthentication, approveStoreRequest);
