...
import { addToCart, buy, changeAddress, changeAvatar, changeBankingInfo, changeGender, changeOnlineStatus, changePassword, changePhoneNumber, favoriteProduct, followStore, getAllUser, getFavoriteListOfAUser, getFollowStore, getUserInfo, requestOpenStore, revomeFromCart, unfavoriteProduct, unfollowStore, viewCart, } from '../controllers/userController.js';
...
router.patch('/favorite/:favoriteProductId', userAuthentication, favoriteProduct);
router.patch('/unfavorite/:unfavoriteProductId', userAuthentication, unfavoriteProduct);
