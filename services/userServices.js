...
export const addToCartServices = async (
  ...
  const sameProductInUserCartIndex = user.cart.content.findIndex(
...
export const requestOpenStoreService = async (userId, requestData) => {
  ...
  const newRequest = await StoreRequest.create(
    Object.assign(Object.assign({}, requestData), {
      requesterId: userId,
...
export const buyService = async (
  ...
  const uploadFeeListToDatabase = await Shipping.create(
    Object.assign({}, feeList)
  );
